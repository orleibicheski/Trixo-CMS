...
/**
 * Query responsável por buscar conteúdos associados do tipo {@link TextoCurto}.
 * 
...
@Named
@ViewScoped
public class TextoCurtoPaginaQuery extends ConteudoPaginaQuery<Map<String, ?>> {
	...
	return gerarJpaQL(TextoCurtoAssociado.class.getSimpleName()).toString();
    }
}
