 ...
 */
@Entity
public class LinkInternoAssociado extends ConteudoAssociado<LinkInterno> {
    ...
    @NotNull
    private LinkInterno conteudo = new LinkInterno();

    /**
     * {@inheritDoc}
     */
    public LinkInternoAssociado() {
	super();
    }
     ...
     * {@inheritDoc}
     */
    public LinkInternoAssociado(Long id, TipoConteudo categoriaTipo,
     ...
     * @return the conteudo
     */
    public LinkInterno getConteudo() {
        return conteudo;
    }
     ...
     *            the Conteudo to set
     */
    public void setConteudo(LinkInterno conteudo) {
