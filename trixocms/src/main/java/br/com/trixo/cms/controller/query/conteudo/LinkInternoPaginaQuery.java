...
import br.com.trixo.cms.entity.conteudo.LinkInterno;
import br.com.trixo.cms.entity.conteudo.LinkInternoAssociado;

/**
 * Query responsável por buscar conteúdos associados do tipo {@link LinkInterno}.
 * 
...
@Named
@ViewScoped
public class LinkInternoPaginaQuery extends ConteudoPaginaQuery<Map<String, ?>> {
    /**
     * serialID.
     */
	...
	return gerarJpaQL(LinkInternoAssociado.class.getSimpleName()).toString();
    }
}
