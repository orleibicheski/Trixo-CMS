 ...
 */
@Entity
public class LinkExternoAssociado extends ConteudoAssociado<LinkExterno> {
    ...
    @NotNull
    private LinkExterno conteudo = new LinkExterno();

    /**
     * {@inheritDoc}
     */
    public LinkExternoAssociado() {
	super();
    }
     ...
     * {@inheritDoc}
     */
    public LinkExternoAssociado(Long id, TipoConteudo categoriaTipo,
     ...
     * @return the conteudo
     */
    public LinkExterno getConteudo() {
        return conteudo;
    }
     ...
     *            the Conteudo to set
     */
    public void setConteudo(LinkExterno conteudo) {
